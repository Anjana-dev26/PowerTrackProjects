...
void run_screen(unsigned char key)
{
    ...
    clcd_putch((minute / 10) + '0', (0x80 + (5)));
    clcd_putch((minute % 10) + '0', (0x80 + (6)));
    clcd_putch(':', (0x80 + (7)));
    clcd_putch((second / 10) + '0', (0x80 + (8)));
    clcd_putch((second % 10) + '0', (0x80 + (9)));
...
void set_temp_screen(unsigned char key)
{
    ...
    clcd_print("*:CLEAR", (0xD0 + (0)));
    clcd_print("#:ENTER", (0xD0 + (9)));
