...
void menu_screen(unsigned char key)
{
    ...
    switch(menu_pos)
    {
        case 0:
            ...
            clcd_print(" 3.Conv       ", (0x90 + (0)));
            clcd_print(" 4.Reheat     ", (0xD0 + (0)));
...
void micro_power_screen(void)
{
    ...
    if(once)
    {
        ...
        clcd_print(" MICRO MODE ", (0xC0 + (2)));
        clcd_print("POWER =1000W", (0x90 + (2)));
...
void set_time_screen(unsigned char key)
{
    ...
    clcd_putch(mm_t + '0',(0xC0 + (5)));
    clcd_putch(mm_u + '0',(0xC0 + (6)));

    clcd_putch(':',(0xC0 + (7)));

    clcd_putch(ss_t + '0',(0xC0 + (8)));
    clcd_putch(ss_u + '0',(0xC0 + (9)));
...
void run_screen(unsigned char key)
{
    ...
    clcd_putch((minute / 10) + '0', (0x80 + (7)));
    clcd_putch((minute % 10) + '0', (0x80 + (8)));

    clcd_putch(':', (0x80 + (9)));

    clcd_putch((second / 10) + '0', (0x80 + (10)));
    clcd_putch((second % 10) + '0', (0x80 + (11)));

    if(running)
        clcd_print("4.RUNNING      ",(0xC0 + (0)));
    else
        clcd_print("4.START/RESUME ",(0xC0 + (0)));

    if(paused)
        clcd_print("5.PAUSED       ",(0x90 + (0)));
    else
